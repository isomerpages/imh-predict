...
<h2>Procedures</h2>
<div class="isomer-card-grid"><a rel="noopener noreferrer nofollow" href="/recruitment" class="isomer-card"><div class="isomer-card-image"><div class="isomer-image-wrapper"><img style="width: 100%" height="auto" width="100%" alt="Placeholder" src="/images/Stock photos/Recruitment/DSC1737.jpg"></div></div><div class="isomer-card-body"><div class="isomer-card-title">Recruitment</div><div class="isomer-card-description">Screening for eligibility.</div><div class="isomer-card-link">Read more</div></div></a>
